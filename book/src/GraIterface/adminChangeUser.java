...
public class adminChangeUser extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adminChangeUser frame = new adminChangeUser();
...
//添加时间响应----------------------------------------------------------
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					updateUser ver = new updateUser();
				    ver.updateuser(userName, password,identity);
